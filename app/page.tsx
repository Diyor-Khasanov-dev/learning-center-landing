...
// Custom Dropdown Option Data
const ROLE_FILTER_OPTIONS: DropdownOption<RoleFilter>[] = [
...
const STUDENT_COUNT_OPTIONS: DropdownOption<string>[] = [
...
export default function Home() {
  ...
  const handleDemoSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      setDemoStep(1)
      setDemoForm({ name: '', phone: '', centerName: '', studentsCount: '100-300', preferredTime: 'Morning (9:00 - 12:00)' })
    }, 2800)
  }
      ...
      <section id='features' className='py-24 bg-[#0a0c1a]/80 relative border-y border-white/10'>
        <div className='mx-auto max-w-7xl px-6'>
          <div className='flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6'>
            ...
            {/* Desktop & Mobile Custom Dropdown Filter */}
            ...
            {demoStep === 1 ? (
              <div className='space-y-4 animate-in fade-in duration-200'>
                ...
                <button
                  ...
                  className='w-full flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-violet-600 to-indigo-600 py-3 text-xs font-bold text-white shadow-lg shadow-violet-600/30 hover:opacity-95 transition-all disabled:opacity-50 disabled:cursor-not-allowed'
                >
              ...
              <div className='space-y-4 animate-in fade-in duration-200'>
                {/* Recreated Manual Custom Dropdown replacing native select */}
                <Dropdown<string>
                ...
                <div className='flex gap-3 pt-2'>
                  <button
                    type='button'
                    onClick={() => setDemoStep(1)}
                    className='w-1/3 rounded-xl border border-white/10 bg-white/5 py-3 text-xs font-bold text-slate-300 hover:bg-white/10 transition-colors'
                  >
                    Back
                  </button>
                  ...
                  <button
                    type='submit'
                    className='w-2/3 rounded-xl bg-gradient-to-r from-violet-600 via-indigo-600 to-cyan-500 py-3 text-xs font-bold text-white shadow-lg shadow-violet-600/30 hover:opacity-95 transition-all'
                  >
                    Confirm &amp; Book Demo
                  </button>
                </div>
