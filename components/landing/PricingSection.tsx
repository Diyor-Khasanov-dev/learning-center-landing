            ...
            return (
              <div
                ...
                className={`relative rounded-2xl p-7 sm:p-8 flex flex-col justify-between transition-all duration-300 ${
                  plan.highlight
                    ? 'border-2 border-blue-600 bg-white dark:bg-neutral-950 shadow-xl scale-105 z-10'
                    : 'border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-950 hover:border-neutral-300 dark:hover:border-neutral-700 shadow-xs'
                }`}
              >
                {plan.highlight && (
                  <div className='absolute -top-3.5 left-1/2 -translate-x-1/2 rounded-full bg-blue-600 px-4 py-1 text-[11px] font-extrabold uppercase tracking-wider text-white shadow-sm flex items-center gap-1.5 whitespace-nowrap'>
                ...
                <div className='space-y-6'>
                  ...
                  <div className='border-y border-neutral-200 dark:border-neutral-800 py-5 space-y-1.5'>
                    <div className='flex items-baseline gap-1.5'>
                      <span className='text-4xl sm:text-5xl font-black text-neutral-900 dark:text-white'>${price}</span>
                ...
                <div className='mt-8 pt-6 border-t border-neutral-200 dark:border-neutral-800'>
                  <button
                    ...
                    className={`w-full rounded-md py-3.5 text-center text-sm font-bold transition-all cursor-pointer whitespace-nowrap ${
                      plan.highlight
