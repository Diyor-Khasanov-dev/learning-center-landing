      ...
      <div className='mx-auto max-w-7xl px-6 grid grid-cols-1 md:grid-cols-5 gap-10'>
        ...
        <div className='space-y-3'>
          ...
          <button
            ...
            className='inline-flex items-center gap-2 rounded-lg bg-violet-600/20 border border-violet-500/30 px-3 py-2 text-xs font-semibold text-violet-300 hover:bg-violet-600 hover:text-white transition-all cursor-pointer'
          >
