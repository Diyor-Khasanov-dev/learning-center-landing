          ...
          <div className='lg:col-span-6 space-y-6 text-center lg:text-left'>
            ...
            <div className='flex flex-wrap items-center justify-center lg:justify-start gap-6 text-xs font-medium text-slate-600 dark:text-slate-400 pt-3'>
              <span className='flex items-center gap-1.5'>
                <CheckCircle2 className='h-4 w-4 text-emerald-600 dark:text-emerald-400' /> 14-Day Free Trial
              </span>
              <span className='flex items-center gap-1.5'>
                <CheckCircle2 className='h-4 w-4 text-emerald-600 dark:text-emerald-400' /> Instant Setup in 15 Mins
              </span>
              <span className='flex items-center gap-1.5'>
                <CheckCircle2 className='h-4 w-4 text-emerald-600 dark:text-emerald-400' /> Free Data Migration
              </span>
            </div>
          </div>
            ...
            <div className='relative rounded-2xl border border-slate-200/80 dark:border-white/15 bg-white/90 dark:bg-[#0e101f]/90 p-4 sm:p-6 shadow-2xl shadow-indigo-200/50 dark:shadow-indigo-950/60 backdrop-blur-2xl transition-colors duration-200'>
              ...
              <div className='flex items-center justify-between pb-4 border-b border-slate-200/80 dark:border-white/10 mb-5'>
                <div className='flex items-center gap-2'>
                  ...
                  <span className='ml-2 text-xs font-mono text-slate-500 dark:text-slate-400'>edusphere.app/admin/dashboard</span>
                </div>
              ...
              <div className='grid grid-cols-2 sm:grid-cols-4 gap-3 mb-5'>
                <div className='rounded-xl border border-slate-200/80 dark:border-white/5 bg-slate-50 dark:bg-white/[0.03] p-3'>
                  <div className='text-[11px] font-medium text-slate-500 dark:text-slate-400'>Active Students</div>
                  <div className='text-lg font-bold text-slate-900 dark:text-white mt-1'>1,428</div>
                  <div className='text-[10px] font-medium text-emerald-600 dark:text-emerald-400 mt-0.5'>↑ +12.4% this mo</div>
                </div>
                <div className='rounded-xl border border-slate-200/80 dark:border-white/5 bg-slate-50 dark:bg-white/[0.03] p-3'>
                  <div className='text-[11px] font-medium text-slate-500 dark:text-slate-400'>Monthly Tuition</div>
                  <div className='text-lg font-bold text-emerald-600 dark:text-emerald-400 mt-1'>$48,920</div>
                  <div className='text-[10px] font-medium text-emerald-600 dark:text-emerald-400 mt-0.5'>98% collected</div>
                </div>
                <div className='rounded-xl border border-slate-200/80 dark:border-white/5 bg-slate-50 dark:bg-white/[0.03] p-3'>
                  <div className='text-[11px] font-medium text-slate-500 dark:text-slate-400'>New Leads CRM</div>
                  <div className='text-lg font-bold text-amber-600 dark:text-amber-400 mt-1'>184</div>
                  <div className='text-[10px] font-medium text-amber-600 dark:text-amber-300 mt-0.5'>32 ready to enroll</div>
                </div>
                <div className='rounded-xl border border-slate-200/80 dark:border-white/5 bg-slate-50 dark:bg-white/[0.03] p-3'>
                  <div className='text-[11px] font-medium text-slate-500 dark:text-slate-400'>Attendance Today</div>
                  <div className='text-lg font-bold text-violet-600 dark:text-violet-400 mt-1'>96.8%</div>
                  <div className='text-[10px] font-medium text-slate-500 dark:text-slate-400 mt-0.5'>QR check-in active</div>
                </div>
              </div>
              ...
              <div className='grid grid-cols-1 sm:grid-cols-3 gap-3 mb-4'>
                <div className='sm:col-span-2 rounded-xl border border-slate-200/80 dark:border-white/5 bg-slate-50 dark:bg-white/[0.03] p-4'>
                  <div className='flex items-center justify-between text-xs mb-3'>
                    <span className='font-semibold text-slate-800 dark:text-slate-200'>Revenue &amp; Debtors Overview</span>
                    <span className='text-slate-500 dark:text-slate-400'>June 2024</span>
                  </div>
                  {/* SVG Chart Graphic */}
                ...
                <div className='rounded-xl border border-slate-200/80 dark:border-white/5 bg-slate-50 dark:bg-white/[0.03] p-3.5 space-y-2.5'>
                  <div className='text-xs font-semibold text-slate-800 dark:text-slate-200 mb-1'>Live Branch Stream</div>
                  ...
                  <div className='flex items-center justify-between text-[11px] bg-slate-100 dark:bg-white/[0.02] p-2 rounded-lg border border-slate-200/80 dark:border-white/5'>
                    <div className='flex items-center gap-2'>
                      ...
                      <span className='text-slate-700 dark:text-slate-300'>Tuition Paid ($120)</span>
                    </div>
                  ...
                  <div className='flex items-center justify-between text-[11px] bg-slate-100 dark:bg-white/[0.02] p-2 rounded-lg border border-slate-200/80 dark:border-white/5'>
                    <div className='flex items-center gap-2'>
                      ...
                      <span className='text-slate-700 dark:text-slate-300'>QR Check-In #492</span>
                    </div>
                  ...
                  <div className='flex items-center justify-between text-[11px] bg-slate-100 dark:bg-white/[0.02] p-2 rounded-lg border border-slate-200/80 dark:border-white/5'>
                    <div className='flex items-center gap-2'>
                      ...
                      <span className='text-slate-700 dark:text-slate-300'>New Lead from IG</span>
                    </div>
              ...
              <div className='absolute -bottom-5 -left-5 hidden sm:flex items-center gap-3 rounded-2xl border border-slate-200 dark:border-white/15 bg-white/95 dark:bg-[#14172c] p-3.5 shadow-xl dark:shadow-2xl backdrop-blur-xl'>
                ...
                <div>
                  <div className='text-xs font-bold text-slate-900 dark:text-white'>Automated Parent SMS</div>
                  <div className='text-[11px] text-slate-600 dark:text-slate-400'>“Your child entered class at 14:00”</div>
                </div>
              </div>
            </div>
          </div>
