        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8'>
          {filteredModules.map((module) => {
            ...
            return (
              <div
                key={module.id}
                className='group relative rounded-2xl border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-950 p-6 sm:p-7 hover:border-blue-600 dark:hover:border-blue-600 transition-all duration-300 flex flex-col justify-between shadow-xs'
              >
