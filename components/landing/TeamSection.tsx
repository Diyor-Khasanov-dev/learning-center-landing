      ...
      <div className='relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
        ...
        <div className='grid gap-6 sm:grid-cols-2 lg:grid-cols-3'>
          {t.members.map((member) => (
            <article
              key={member.id}
              className='group relative flex min-h-[28rem] flex-col overflow-hidden rounded-2xl border border-neutral-200 bg-white p-2 shadow-xs transition-all duration-300 hover:border-blue-600 dark:border-neutral-800 dark:bg-neutral-950 dark:hover:border-blue-600'
            >
                  ...
                  <div className='flex items-center gap-2'>
                    {member.github && (
                      <a
                        ...
                        className='flex h-8 w-8 items-center justify-center rounded-md border border-neutral-200 bg-neutral-50 text-neutral-600 transition-all hover:bg-blue-600 hover:text-white dark:border-neutral-800 dark:bg-neutral-900 dark:text-neutral-400 dark:hover:bg-blue-600 dark:hover:text-white'
                      >
