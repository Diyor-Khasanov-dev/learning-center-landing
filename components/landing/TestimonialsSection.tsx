      ...
      <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
          {t.testimonials.map((testimonial, idx) => (
            <div
              key={idx}
              className='group relative rounded-2xl border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-950 p-7 flex flex-col justify-between space-y-6 hover:border-blue-600 dark:hover:border-blue-600 transition-all duration-300 shadow-xs'
            >
              <div className='space-y-4 relative'>
                <Quote className='absolute -top-2 -right-2 h-8 w-8 text-neutral-200 dark:text-neutral-800 pointer-events-none' />
              ...
              <div className='pt-5 border-t border-neutral-200 dark:border-neutral-800 space-y-4'>
                ...
                <div className='flex items-center gap-3.5'>
                  <Image
                    ...
                    width={48}
                    height={48}
                    className='h-12 w-12 rounded-full object-cover border-2 border-neutral-200 dark:border-neutral-800'
                  />
                  <div>
