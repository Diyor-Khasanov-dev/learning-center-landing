...
export function Navbar() {
  ...
  return (
    <header className='fixed top-0 left-0 right-0 z-50 border-b border-slate-200/80 dark:border-white/10 bg-white/85 dark:bg-[#07080e]/85 backdrop-blur-3xl transition-colors duration-200'>
