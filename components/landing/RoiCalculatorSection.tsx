      ...
      <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10'>
        <div className='grid grid-cols-1 lg:grid-cols-12 gap-12 items-center'>
          ...
          <div className='lg:col-span-6 space-y-6'>
            ...
            <div className='space-y-3 bg-white dark:bg-neutral-950 p-6 rounded-2xl border border-neutral-200 dark:border-neutral-800 shadow-xs'>
          ...
          <div className='lg:col-span-6'>
            <div className='rounded-2xl border border-neutral-800 bg-neutral-900 dark:bg-black p-8 sm:p-10 shadow-2xl space-y-8 relative overflow-hidden text-white'>
              ...
              <div className='grid grid-cols-1 sm:grid-cols-2 gap-4'>
                <div className='bg-neutral-950 p-5 rounded-xl border border-neutral-800 space-y-1'>
              ...
              <div className='pt-2 space-y-3'>
                <button
                  ...
                  className='w-full rounded-md bg-blue-600 hover:bg-blue-700 py-4 text-center text-sm font-bold text-white shadow-xs transition-all cursor-pointer'
                >
                  {t.auditBtn}
                </button>
